...
This version of the terrain generator library interpreter is set up to produce terrain using Simplex noise.
...
Additional display options may be viewed by swapping WHICH_COLOR_SCHEME constant is commented.
...
#starfieldish, remember to set color values of <= 3, <= 6, <= 9 etc instead of == 1, == 2, == 3 etc... easier to find positives, but is it actually the best bet?
#NOISE_FREQUENCY = 2
#NOISE_OCTAVES = 2
#NOISE_PERSISTENCE = 0.02
